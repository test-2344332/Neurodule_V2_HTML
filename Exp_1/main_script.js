...
img_candle.onload = function () {
	candle_img = new Customimage(0, 0, 2, display, 600, 914, img_candle, 575, 50, 300, 457, candle);
...
img_feather.onload = function () {
	feather_img = new Customimage(0, 0, 2, display, 600, 914, img_feather, 575, 50, 300, 457, feather);
